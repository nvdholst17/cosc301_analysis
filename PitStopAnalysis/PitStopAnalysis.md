# Pitstop Analysis: How do pit stop times vary between constructors and years
...
Pistops are very critical during an F1 race, constructors (teams) are vital in the duration of pitstops. 

Previous to 2010: pitstops included refueling and changing tires
Present (2010+): pitstops only involve changing tires 

This is important to know as the data stretches back from 1950 to 2024, so the pitstop change from 2010-2024 is drastic and changes the data. Since this question is analyzing how pitstops have changes due to constructors and years we must know: 
...
![F1 Pit Stop Duration by Year](Q2-PitStopLineChart.jpg)
The fastest year average is 2012 at 23.284 seconds. After this we see a large spike from 2012 to 2015 indicating there may have been regulation changes causing this increase of time. The 2014 jump likely indicates the new hybrid power unit regulations increasing stop complexity. After this the trend stabalizes and varies between 24.5 and 25.5 second pit stops. 

We can tell by this visualization that the biggest factor that changes pit stop duration are the regulations imposed on the race. During the refuel era we can assume that pit stops took longer because constructors had to refuel and change tires. At the beginning of the new reforms (2011-2012), pit stops average very low. The spike, indicating the slowest pit stop times occuring at 2015 with an average of 25.500 seconds are due to new regulations implemented. Therefore these regulations have a very large impact on pit stop duration.
...
## Second Analysis:
## Constructor Pit Stop Performance (2011 - 2024 Cummulative)
...
![F1 Constructor Pit Stop Performance](Q4-ConstrPerformance.jpg)
...
Standard deviation (std) represents how much a teams pit stop times vary from their own average. The colour of the bars represent the standard deviation, blue meaning the average is consistent, and red meaning theres high variety in pit stop times. A low std means a team performs roughly the same the speed every pit stop, meaning theyre more reliable and consistent when racing. High std may mean inconsistencies or errors which are a disadvanatge when racing.
...
![F1 Individual Constructor Pit Stop Performance](Q4-ConstrPerformance.jpg)
...
- HRT, Manor Marussia, Haas are towards the bottom in redder tones because they are backmarker teams with less pit crew investment
- In 2011: Red Bull was leading, in 2024: McLaren was leading. Rankings show that esceeding in pit stop performance is not a permanent factor, performance will fluctuate.


*** INSERT image 1 and image 3 to be side by side ***
<div style="display: flex; gap: 20px;">
  <img src="Q4-ConstrPerformance.jpg" width="48%">
  <img src="Q2-PitStopLineChart.jpg" width="48%">
</div>

Analyzing the heat map by column, we can see 2011 and 2012 were strong years for all teams with consisntently fast pit stop times. We also see a following decline in 2014 and 2015 in performance by majority of constructors. These findings directly correspond with our first year-level average line graph where we see a significant increase on average pit stop time during this period. We can point the simultaneous change towards the regulation change. Overall, 2012–2013 column range appears greener while the 2014–2016 period shifts red, reflecting the hybrid era transition adding complexity.
...
To provide more context, we also evaluate the top 25 fastest individual pit stops recorded in the datatset. Our previous analysis were done on year level averages and constructor performance. Instead this query will analyze isolated peak performance. 

![F1 Top 25 Fastest Pit Stops](Q8-Top25FastestPS.jpg)

We can visually see that the top 25 are split into two clustors, the left resembling the fastest (12.897 - 13.335 seconds) and the right being slower (13.9 - 14.114 seconds). We see the drivers that are a part of the left cluster contain: 
...
The right cluster is important a different reason because six of the existing stops occur duing the 2022 Dutch Grand Prix. Since these are different constructors producing very similar stop times in the same race, it indicates that the circuit conditions were the primary factor of the fast stops, not the constructors.
